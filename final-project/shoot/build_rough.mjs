...
const PLAN = [
  ...
  //
  // 이 컷은 유일하게 앱 화면이 아니라 터미널이다. 화면 전체가 psql 출력이라
  // 그냥 두면 "코드가 지나갔다"로만 읽힌다 — 정작 증거는 결과 한 줄
  // (`주문 34 | 체결 34 | 중복주문키 0 | 중복체결id 0`)이다. 거기만 남긴다.
  { file: 's5-verify.mp4', badge: null, subs: [
    { png: 'sub-verify.png', from: 1.0, to: 9.0 },
  ], spots: [
    { x: 46, y: 570, w: 1040, h: 118, from: 3.4, to: 9.0 },
  ] },
