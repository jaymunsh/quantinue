...
소스는 **Alpaca 단독으로 확정**(2026-07-20). 대안 조사는 끝났고 되묻지 마라 —
Marketaux 무료는 요청당 기사 3건이라 하루 300건이 한계고, Finnhub는 전 시장
엔드포인트에 티커 태깅이 없고, Polygon은 무료 티어에 뉴스가 없다. 나중에 뉴스에
투표권이 필요해지면 보도자료 와이어 RSS(로드맵 R11)가 무료 경로다 — 지금은 안 만든다.
