...
- [x] 완료 — 커밋: `de17a5e`(계약 개방) · `f34af53`(A/B 게이트) · `2233317`(계보·되쓰기 판정) · `73c9a8e`(관제실 노출) / 실 LLM 44분석 skip 0, 서사 88% (2026-07-20)
...
- [x] 완료 — 커밋: `1571ee6` (2026-07-20). 60초 간격 판정 확인 · exits 잡이 켜자마자 자율 실행/succeeded · 이월 규칙(D3) 실증
...
- [x] 완료 — 커밋: `d4dc7f2` (2026-07-20). −3,675줄 · RunStore 12메서드 삭제 · postgres.py 3분할 흡수 · core/contracts 668→109줄 · 살려낸 것: portfolio_marks(전량 청산 시 실현손익 소멸 결함 — 실행 확인)
...
- [x] 완료 — 커밋: `6f2fadd` (2026-07-20). 캘린더 구현 1개 · 리뷰 T+5가 XNYS 실물 달력으로 · 경계는 CalendarHorizonError로 명시(지어내지 않음) · Good Friday 검증
...
- [x] 완료(1단계 범위) — 커밋: `4be9b19` (2026-07-20). businesswire 폐기 실측 확인(410 Gone) → globenewswire·prnewswire 2와이어로 확정 · 실수집 90행/62티커 · 분석 프롬프트에 [wire] 태그 도달 · 2단계(news_score 채점 잡)는 별도 결정
