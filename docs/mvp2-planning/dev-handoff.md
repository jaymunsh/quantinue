...
| 테스트 | 유닛/웹 **859 green** · 통합 **118 green** · ruff clean (재설계 착수 기준선은 681/63) |
...
**Phase 3 완료(7/7).** 다음은 4(배분 잡·**구 러너 폐기 = 유일한 확인 지점**) → 5(정리).
⚠️ Phase 4 착수 전에 위 "발견한 것" 1번(프롬프트에 지표가 없다)을 먼저 볼 것 — 승인이 안 나면 배분할 후보가 없다.
